  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 flex min-h-[calc(100vh-4rem)] items-center pb-24 pt-16 sm:min-h-[650px] sm:pt-12 md:min-h-[560px] md:pb-20 lg:min-h-[610px] xl:min-h-[660px]">
        <div className="w-full max-w-[430px] sm:max-w-[500px] lg:max-w-[520px]">
          ...
          <h1 className="mt-4 font-serif text-[clamp(2.25rem,10vw,3.15rem)] font-bold leading-[1.06] tracking-tight text-[#173f23] sm:hidden">
            <Reveal as="span" className="block" delay={0.15} y={15}>
              Pure Indian Spices
            </Reveal>
            <Reveal as="span" className="block" delay={0.25} y={15}>
              <span className="font-normal italic text-[#5b8c2f]">from our farms</span>
            </Reveal>
            <Reveal as="span" className="block" delay={0.35} y={15}>
              to Your Home
            </Reveal>
          </h1>
          ...
          <h1 className="mt-4 hidden font-serif text-[clamp(3.15rem,6.2vw,4.25rem)] font-bold leading-[1.06] tracking-tight text-[#173f23] sm:block md:text-[clamp(3.15rem,4.5vw,4.10rem)] xl:text-[4.5rem]">
            ...
            <Reveal as="span" className="block" delay={0.28} y={15}>
          ...
          <Reveal delay={0.55} y={15}>
            <div className="mt-8 flex flex-col sm:flex-row gap-3.5">
              <Link
                href="#products"
                className="group inline-flex h-11 sm:h-12 w-full sm:w-auto items-center justify-center gap-2 rounded-[6px] bg-[#123d26] px-5 sm:px-6 text-[13px] sm:text-[13.5px] font-bold text-[#fff8ec] shadow-[0_16px_30px_rgba(18,61,38,0.2)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#5b8c2f]"
              >
                Explore Products
              ...
              <Link
                href="#why-choose-us"
                className="group inline-flex h-11 sm:h-12 w-full sm:w-auto items-center justify-center gap-2 rounded-[6px] border border-[#d6dccf] bg-[rgba(251,248,242,0.82)] px-5 sm:px-6 text-[13px] sm:text-[13.5px] font-bold text-[#173f23] shadow-[0_14px_28px_rgba(35,79,44,0.1)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5 hover:border-[#173f23] hover:bg-[#fffaf0]"
              >
                Learn More
                <ArrowRight className="h-4 w-4 transition-transform duration-300 group-hover:translate-x-0.5" />
              </Link>
