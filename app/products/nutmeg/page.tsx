...
export const metadata: Metadata = {
  title: "Premium Wholesale Nutmeg & Mace Exporter | Spize Spices",
  description: "Buy bulk whole nutmeg (with and without shell) and premium red mace sourced from Kerala, India. Safe hygienic B2B packaging and global shipping.",
  alternates: { canonical: "/products/nutmeg" },
}

export default function NutmegProductPage() {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Product",
            "name": "Whole Nutmeg and Mace",
            "image": "https://res.cloudinary.com/xug0w0py/image/upload/f_auto,q_auto/v1/products-nutmeg_xwntos",
            "description": "Bold nutmeg seeds and vibrant crimson mace arils sourced from organic growers in Kerala, India.",
            "brand": {
              "@type": "Brand",
              "name": "Spize Spices"
            },
      ...
      <section className="py-8 sm:py-12">
        <div className="container max-w-3xl mx-auto px-6">
          ...
          <div className="relative aspect-[1.8] w-full overflow-hidden rounded-[8px] bg-neutral-50 border border-neutral-100 mb-8">
            <Image
              src="https://res.cloudinary.com/xug0w0py/image/upload/f_auto,q_auto/v1/products-nutmeg_xwntos"
              alt="Premium Nutmeg and Mace"
              fill
          ...
          <div className="prose prose-neutral max-w-none text-neutral-800 leading-[1.8]">
            <p>
              Harvested in the heart of Kerala's organic gardens, nutmeg is a dual spice producing both the hard nutmeg seed and the lacy crimson cover called mace. Each spice has its distinct nutty sweet-spicy flavour and chemical properties.
            </p>

            <h2 className="font-serif text-xl sm:text-2xl font-bold text-neutral-950 mt-8 mb-4">
              Available Nutmeg & Mace Types
            </h2>
            <p className="mb-6">
              We process and pack several whole and shell-on variants. Select a type to enquire:
            </p>

            <div className="space-y-4 my-6">
              {[
                { type: "Whole Nutmeg (Without Shell)", desc: "Hand-graded whole nutmeg seeds, sorted to remove broken pieces. High volatile oil density.", waMsg: "Hi, I am interested in Whole Nutmeg (Without Shell)." },
                { type: "Whole Nutmeg (With Shell)", desc: "Natural shell-on nutmeg seeds, providing extended shelf life and natural aroma preservation.", waMsg: "Hi, I am interested in Whole Nutmeg (With Shell)." },
                { type: "Premium Red Mace (Javitri)", desc: "Fully dried vibrant red-orange arils, hand-graded into whole flower cups. Sweet, fragrant scent.", waMsg: "Hi, I am interested in Premium Red Mace." }
              ].map((variant) => (
